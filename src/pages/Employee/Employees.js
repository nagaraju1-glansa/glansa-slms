...
const Member = () => {
  ...
  const columns = [
    { name: 'employee.no.', selector: row => row.employeeid, sortable: true },
     ...
     <React.Fragment>
        ...
        <div>
          <div className='page-title-box d-sm-flex align-items-center justify-content-between'>
              ...
              <button type="button" className="btn btn-success waves-effect waves-light"  onClick={()=> navigate('/employeeadd') }>
