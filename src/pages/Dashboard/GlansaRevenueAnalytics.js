...
//Import Charts
import { GlansaRevenueAnalyticsChart } from './Charts'
import "./dashboard.scss";
import { CustomFetch } from '../ApiConfig/CustomFetch';

const GlansaRevenueAnalytics = () => {
    ...
    useEffect(() => {
        ...
        return (
            <React.Fragment>
                <Card>
                    <CardBody>
                        <h4 className="card-title mb-2">Monthly Wise Collections</h4>
                        <div id="line-column-chart" className="apex-charts" dir="ltr">
                            <GlansaRevenueAnalyticsChart />
                        </div>  
                    </CardBody>
...
export default GlansaRevenueAnalytics;